...
legend({strcat('$\|K{e}_{3}\|^2$'), ...
    strcat(['$\frac{\tilde{\omega}}{\psi^2(1+\frac{\psi}{\phi})^2}\|\sum_{j\in \mathcal{N}_{3}}a_{3j}K(\hat{x}_{3}-\hat{x}_{j})\|^{2}+\tilde{\beta}\tilde{\sigma}_3(t)$']),'${t}^3_k$'},'NumColumns',3,'Interpreter','Latex','FontSize',10')
